...
func main() {
	username := "lypwyt"
	token := "b46eea6c7fd284e1c88b7755eab45549659fee80"
	filehash := "f60fc352e1e3b32496776a91913ada57c8714853"
	...
	// 3. 请求分块上传接口
	filename := "/home/lyp/tmp/goland-2023.2.3.exe"
	tURL := "http://localhost:8080/file/mpupload/uppart?" +
		"username=lypwyt&token=" + token + "&uploadid=" + uploadID
