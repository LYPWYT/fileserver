...
func UploadHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		fileMeta := meta.FileMeta{
			...
			Location: "/home/lyp/tmp/" + head.Filename,
		...
		//if err != nil {
		//	fmt.Printf("Upload failed: %v", err.Error())
		...
		suc := meta.UpdateUserFileMetaDB(username, fileMeta)
		if suc {
			// 重定向状态码 http.StatusFound
